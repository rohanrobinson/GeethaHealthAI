...
- **Sharing:** PDF medical-summary export via share sheet; FHIR bundle export ([m5-polish.md](m5-polish.md)).
...
| M4 | Apple Health Records import ([health-records-import.md](health-records-import.md)) | ✅ Shipped |
| M5 | Polish: FHIR bundle export, Face ID lock, storage-used row, Dynamic Type pass ([m5-polish.md](m5-polish.md)) | ✅ Shipped |
| M6 | TestFlight → App Store submission | TestFlight live (internal + external); App Store submission pending |
...
- [x] Create app record in App Store Connect — "Geetha Health", bundle `com.geethahealth.GeethaHealth`, app ID 6790617715; build 0.1.0 (2) live in TestFlight for internal + external testers
...
- Privacy  label: fully on-device should qualify as "Data Not Collected".
